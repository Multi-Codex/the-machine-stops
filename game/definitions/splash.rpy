...
init python:
    ...
    splash_messages = [
        ...
        "Dedicated to iiTzWolfyy and Headlocker."
    ]
...
image menu_art_m:
    ...
    ycenter 500
    zoom 0.75
    menu_art_move(0.75, 1000, 0.75)

image menu_k:
    subpixel True
    "mod_assets/mod_extra_images/menu_k.png"
    xcenter 1150
    ycenter 385
    zoom 0.50
    menu_art_move(0.54, 600, 0.60)
...
image menu_nav:
    "mod_assets/frame1.png"
    xcenter 640
    ycenter 360
    zoom 1.1
    #recolorize("gui/overlay/main_menu.png", "#D4AF37")
...
image tos = "mod_assets/modbg2.png"
image tos2 = "mod_assets/modbg.png"
...
label splashscreen:
    ...
    if not persistent.first_run:
        ...
        "It is should be noted that this mod is largely unfinished and never will be finished, as I've decided to make this into its own visual novel, separate from DDLC."
        "Large parts of this mod are either unfinished and/or uncoded as well."
        "This mod is not reccommended for playthroughs on YouTube or other platforms for this reason."
    ...
    $ config.main_menu_music = audio.chasecars
    $ renpy.music.play(config.main_menu_music)
...
label before_main_menu:
    $ config.main_menu_music = audio.chasecars
    $ renpy.notify("John Rod Dondoyano-Chasing Cars")
    return
