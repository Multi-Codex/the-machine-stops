...
define -2 text_outline_color = "#e3b130"
...
style frame:
    ...
    background Frame(recolorize("mod_assets/frame.png"), gui.frame_borders, tile=gui.frame_tile)
...
screen say(who, what):
    ...
    window:
        if who is None:
            if textbox_color == "pink":
                style "window_n"
                id "window_n"
            elif textbox_color == "blue":
                style "window_s"
                id "window_s"
            elif textbox_color == "purple":
                style "window_y"
                id "window_y"
            elif textbox_color =="green":
                style "window_m"
                id "window_m"
            elif textbox_color == "orange":
                style "window_o"
                id "window_o"
            elif textbox_color == "silver":
                style "window_k"
                id "window_k"
            elif textbox_color == "red":
                style "window_p"
                id "window_p"
        else:
            style "window"
...
style namebox:
    ...
    background ConditionSwitch(
        "_last_say_who == 'mc'", Frame("mod_assets/namebox_mc.png", gui.namebox_borders, tile=gui.namebox_tile, xalign=gui.name_xalign),
        "_last_say_who == 's'", Frame("mod_assets/namebox_s.png", gui.namebox_borders, tile=gui.namebox_tile, xalign=gui.name_xalign),
        "_last_say_who == 'm'", Frame("mod_assets/namebox_m.png", gui.namebox_borders, tile=gui.namebox_tile, xalign=gui.name_xalign),
        "_last_say_who == 'n'", Frame("mod_assets/namebox_kk.png", gui.namebox_borders, tile=gui.namebox_tile, xalign=gui.name_xalign),
        "_last_say_who == 'y'", Frame("mod_assets/namebox_y.png", gui.namebox_borders, tile=gui.namebox_tile, xalign=gui.name_xalign),
        "_last_say_who == 'k'", Frame("mod_assets/namebox_k.png", gui.namebox_borders, tile=gui.namebox_tile, xalign=gui.name_xalign),
        "_last_say_who == 'dy'", Frame("mod_assets/namebox.png", gui.namebox_borders, tile=gui.namebox_tile, xalign=gui.name_xalign),
        "_last_say_who == 'a'", Frame("mod_assets/namebox.png", gui.namebox_borders, tile=gui.namebox_tile, xalign=gui.name_xalign),
        "_last_say_who == 'd'", Frame("mod_assets/namebox.png", gui.namebox_borders, tile=gui.namebox_tile, xalign=gui.name_xalign),
        "_last_say_who == 'v'", Frame("mod_assets/namebox.png", gui.namebox_borders, tile=gui.namebox_tile, xalign=gui.name_xalign)
        )
    padding gui.namebox_borders.padding

style window_s is window:
    background Transform("mod_assets/s_name.png", xalign=0.5, yalign=1.0)

style window_m is window:
    background Transform("mod_assets/m_name.png", xalign=0.5, yalign=1.0)

style window_n is window:
    background Transform("mod_assets/n_name.png", xalign=0.5, yalign=1.0)

style window_y is window:
    background Transform("mod_assets/y_name.png", xalign=0.5, yalign=1.0)

style window_k is window:
    background Transform("mod_assets/k_name.png", xalign=0.5, yalign=1.0)

style window_o is window:
    background Transform("mod_assets/mc_name.png", xalign=0.5, yalign=1.0)

style window_p is window:
    background Transform("mod_assets/p_name.png", xalign=0.5, yalign=1.0)
...
style say_label:
    ...
    outlines [(3, "#6a6a6a", 0, 0), (1, "#6a6a6a", 1, 1)]
...
screen navigation():
    ...
    vbox:
        ...
        if not persistent.autoload or not main_menu:
            ...
            textbutton _("Desktop") action Function(renpy.jump_out_of_context, "dokidesk_call")
...
style navigation_button_text:
    ...
    font "mod_assets/fonts/Tektur.ttf"
    color "#fff"
    #outlines [(4, text_outline_color, 0, 0), (2, text_outline_color, 2, 2)]
    outlines [(4, "#271313", 0, 0), (2, "#271313", 2, 2)]
    hover_outlines [(4, "#613a3a", 0, 0), (2, "#613a3a", 2, 2)]
    insensitive_outlines [(4, "#bd9090", 0, 0), (2, "#bd9090", 2, 2)]
...
style game_menu_outer_frame:
    ...
    background "mod_assets/mod_extra_images/menubar.png"
...
style game_menu_label_text:
    font "mod_assets/fonts/Kings-Regular.ttf"
    size gui.title_text_size
    color "#fff"
    #outlines [(6, text_outline_color, 0, 0), (3, text_outline_color, 2, 2)]
    outlines [(6, "#522", 0, 0), (3, "#522", 2, 2)]
    yalign 0.5
    ...
    use game_menu(_("Credits"), scroll="viewport"):
        ...
        window:
            ...
            vbox:
                ...
                text "Made with Bronya-Rand's {a=https://github.com/Bronya-Rand/DDLCModTemplate2.0}DDLC Mod Template 2.0{/a}.\nCopyright © 2019-" + str(datetime.date.today().year) + " Azariel Del Carmen (Bronya-Rand).\n"
                text "All rights reserved."
                text " "
                text "Doki Doki Literature Club. Copyright © 2017 Team Salvato.\n"
                text "All rights reserved."
                text " "
...
screen save_name_input(message, ok_action):
    ...
    frame:
        ...
        vbox:
            ...
            input default "" value VariableInputValue("save_name") length 16 allow "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz 123456789"
                ...
                for i in range(gui.file_slot_cols * gui.file_slot_rows):
                    ...
                    button:
                        if renpy.get_screen("load"):
                            ...
                            action [SetVariable("save_name", ""), Show(screen="save_name_input", message="Save Name", ok_action=[Hide(screen="save_name_input"), FileActionMod(slot)])]
...
style slot_button is default:
    ...
    idle_background Frame("mod_assets/slot.png", gui.choice_button_borders)
    hover_background Frame("mod_assets/slot_select.png", gui.choice_button_borders)
...
style pref_label_text:
    ...
    size 24
    color "#fff"
    outlines [(3, "#271313", 0, 0), (1, "#271313", 1, 1)]
    yalign 1.0
...
transform notify_appear:
    ...
    alpha 0
    on show:
        easein 1 xoffset 10 alpha 1.0
    on hide:
        easein 1 xoffset -10 alpha 0
